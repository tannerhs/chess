...
//            if(!validMove(move,team) || !piece.pieceMoves(board, move.getStartPosition()).contains(move)) {
...
//
//
//    public boolean movePutsOwnTeamInCheck(ChessMove move,TeamColor team) {
//        if(!isInCheck(team)) {  //not in check before move but yes after move
//            //
//        }
...
//    }
//
//    public boolean moveDoesNotRemoveCheckWhenPossible(ChessMove move, TeamColor team) {
//        //FIXME
//        return false;
//    }
//
//
//
//    public boolean validMove(ChessMove move, TeamColor team) {
...
//
//
//    public boolean isPawnPromotionMove(ChessMove move, TeamColor team) {  //FIXME, MAGIC NUMBER
//        ChessPiece piece = board.getPiece(move.getStartPosition());
...
//        System.out.println("null value returned by findKing");
//        ChessPiece test = board.getPiece(new ChessPosition(6,4));
//        System.out.println(test);
//        System.out.println(kingPiece.getTeamColor());
//        System.out.println(kingPiece);
//        System.out.println(kingPiece.equals(test));
        return null;  //should never happen...
    }
        ...
        for(int r=1; r<=BOARD_LENGTH; r++) {  //I already accounted for no 0-indexing in my loop start point
            for(int c=1; c<= BOARD_WIDTH; c++) {
                ...
                if(piece!=null && piece.getTeamColor()==team) {  //this only checks color for non-null pieces
                    for(ChessMove move: piece.pieceMoves(board,pos )) {
                        //check move to see if it puts playing team in check, FIXME
                        //if(!movePutsOwnTeamInCheck(move)) {  //FIXME CONTROL team color?
                            allTeamPositions.add(move);
                            //
                        //}
                    }
    ...
    public boolean movePutsOwnTeamInCheck(ChessMove move) {
        try {
            ...
            //teamColor=team;  //FIXME, THIS OR LINE ABOVE IS WRONG, when you change it different tests pass
